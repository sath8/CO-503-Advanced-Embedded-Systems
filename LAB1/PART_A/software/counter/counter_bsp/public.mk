...
SOPCINFO_FILE := D:/altera/lab1a/SoC.sopcinfo
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x81030
SOPC_SYSID_FLAG += --sidp=0x81030
ELF_PATCH_FLAG  += --sidp 0x81030

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1712155978
SOPC_SYSID_FLAG += --timestamp=1712155978
ELF_PATCH_FLAG  += --timestamp 1712155978
